...
export const Route = createFileRoute("/products/")({
  ...
  errorComponent: ({ error }) => <div className="mx-auto max-w-3xl px-4 py-24 text-center"><h1 className="font-serif text-3xl">Couldn't load products</h1><p className="mt-3 text-muted-foreground">{error.message}</p></div>,
});
